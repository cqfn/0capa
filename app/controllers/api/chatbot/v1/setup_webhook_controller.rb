        ...
        def index
          ...
          if project.source == 'github'
            ...
            hook = HTTP[accept: 'application/vnd.github.v3+json', Authorization: "Bearer #{cookies[:github_token]}"].post(
              "#{project.repo_url}/hooks", json: { name: 'web', active: true, events: ['issue_comment'], config: { url: 'https://0capa.ru/api/chatbot/v1/github_webhooks', content_type: 'json', insecure_ssl: '0', secret: 'GITHUB_WEBHOOK_SECRET' } }
            )
